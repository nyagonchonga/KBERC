...
standardized_spacing_css = """<style jsx global>{`
        /* ─── A4 Page Container Grid & Standardized Spacing ───────────────────── */
        .a4-page {
          width: 210mm;
          height: 297mm;
          max-height: 297mm;
        ...
        .a4-fm-assembly { font-family: sans-serif; font-size: 10px; font-weight: 700; color: #64748b; letter-spacing: 0.15em; text-transform: uppercase; margin-bottom: 24px; }
        .a4-fm-billno { font-family: sans-serif; font-size: 11px; font-weight: 800; color: #059669; margin-bottom: 28px; }
        .a4-fm-title { font-family: 'Merriweather', serif; font-size: 15px; font-weight: 900; line-height: 1.6; color: #0f172a; margin-bottom: 28px; padding: 0 8mm; }
        ...
        /* ─── Table of Contents (TOC) Standardized Spacing ───────────────────── */
        ...
        .a4-toc-part-title { font-family: sans-serif; font-size: 11px; font-weight: 900; text-transform: uppercase; color: #047857; margin-top: 14px; margin-bottom: 4px; letter-spacing: 0.05em; }
        .a4-toc-sec-row { display: flex; font-size: 12px; line-height: 1.6; color: #1e293b; margin-bottom: 2px; }
        ...
        /* ─── Statutory Part & Section Headings Spacing ───────────────────────── */
        ...
        .a4-part-title { font-family: 'Merriweather', serif; font-size: 13px; font-weight: 900; text-transform: uppercase; color: #0f172a; margin-top: 4px; }
        
        /* ─── Section Block Grid & Margin Column Standardized Spacing ─────────── */
        .a4-section-block { display: flex; align-items: flex-start; margin-bottom: 12px; border-radius: 4px; padding: 2px 0; transition: background 0.15s; cursor: pointer; width: 100%; box-sizing: border-box; }
        ...
        .a4-section-body { flex: 1; min-width: 0; display: flex; align-items: flex-start; gap: 8px; font-size: 12px; line-height: 1.7; color: #1e293b; text-align: justify; }
        .a4-section-number { font-family: sans-serif; font-weight: 900; font-size: 12.5px; min-width: 28px; max-width: 28px; flex-shrink: 0; color: #0f172a; }
        .a4-section-number-spacer { min-width: 28px; max-width: 28px; flex-shrink: 0; }
        .a4-section-text { flex: 1; min-width: 0; margin: 0; font-size: 12px; line-height: 1.7; word-break: break-word; }
        .a4-subclause-text { padding-left: 16px; text-indent: -16px; font-size: 12px; margin-bottom: 4px; }
        
        /* ─── Schedule Headers Standardized Spacing ───────────────────────────── */
        .a4-schedule-header { text-align: center; margin: 20px 0 12px; border-top: 2px solid #cbd5e1; padding-top: 14px; }
        .a4-schedule-label { font-family: sans-serif; font-size: 11px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.15em; color: #059669; margin-bottom: 4px; }
        .a4-schedule-title { font-family: 'Merriweather', serif; font-size: 13px; font-weight: 900; color: #0f172a; }
        .a4-schedule-text { font-size: 12px; line-height: 1.7; color: #334155; text-align: justify; margin-bottom: 8px; }
...
content = content[:css_start_idx] + standardized_spacing_css + content[css_end_idx + len("`}</style>"):]
read_path.write_text(content, encoding="utf-8")
print("Successfully standardized all grid, padding, margin, and baseline spacing across the A4 Reader!")
