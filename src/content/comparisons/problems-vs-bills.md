---
title: "Comprehensive Legal Treatise & Section-by-Section Forensic Critique: The Architectural and Quantity Surveying Practitioners Bill, 2026 (National Assembly Bills No. 47)"
id: "problems-vs-bills"
sidebarTitle: "A&QS Bill 2026: Section-by-Section Legal Critique"
description: "An exhaustive, lawyer-grade section-by-section legal analysis, constitutional assessment, verbatim statutory quotes, cited Kenyan case law (eKLR), practitioner frontline stress-tests, and optimal legislative redrafts across all 10 Parts, 59 Clauses, and the Schedule of National Assembly Bill No. 47."
scoreHistSafety: 65
scoreHistAutonomy: 80
scoreHistDeterrence: 60
scoreHistModernization: 70
scoreDraftSafety: 65
scoreDraftAutonomy: 80
scoreDraftDeterrence: 60
scoreDraftModernization: 70
penaltyHist: 1000000
penaltyDraft: 1000000
boardHistArch: 4
boardHistQS: 4
boardHistEng: 0
boardHistState: 2
...
```mermaid
flowchart TD
    subgraph "The A&QS Practitioners Board Quorum (Clause 7 Composition Breakdown)"
        B_CHAIR["Cabinet Secretary Appointee: Chairperson (1 Seat)<br><i>'Experience in A&QS Practice'</i>"]
        B_EX1["Chief Architect (Ministry of Public Works) (1 Seat)"]
        B_EX2["Chief Quantity Surveyor (Ministry of Public Works) (1 Seat)"]
        B_A["Registered Architects (2 Seats)"]
        B_QS["Registered Quantity Surveyors (2 Seats)"]
        
        B_LA["Landscape Architect (1 Token Seat)"]
        B_ID["Interior Designer (1 Token Seat)"]
        B_CPM["Construction Project Manager (1 Token Seat)"]
        B_TECH["Enrolled Technician (1 Token Seat)"]
        
        B_CHAIR --- B_EX1 --- B_EX2 --- B_A --- B_QS
        
        subgraph "Dominant Establishment Bloc (7 of 11 Voting Seats = 63.6%)"
            B_CHAIR
            B_EX1
            B_EX2
            B_A
        ...
        subgraph "Subordinated Allied & TVET Minority (4 of 11 Voting Seats = 36.4%)"
            B_LA
            B_ID
            B_CPM
            B_TECH
...
```mermaid
flowchart TD
    subgraph "PILLAR 1: The Statutory Regulator (BORAQS / Council)"
        R1["<b>Legal Status:</b> Statutory State Agency (Cap 525 / Bill No. 47)"]
        R2["<b>Core Mandate:</b> Public Safety, Official Licensing, Criminal Prosecution of Quacks"]
        R3["<b>Membership:</b> Mandatory by Law to Practice"]
        R4["<b>Statutory Register:</b> Holds legal custody of practitioner licenses & disciplinary sanctions"]
    end

    subgraph "PILLAR 2: The Professional Member Associations (AAK, IQSK, IDAK, KSELA, ACMK)"
        A1["<b>Legal Status:</b> Independent Civil Society Bodies (Societies Act Cap 108)"]
        A2["<b>Core Mandate:</b> Member Advocacy, Standard Contract Forms, Research, Public Policy"]
        A3["<b>Membership:</b> Voluntary Professional Community"]
        A4["<b>Professional Development:</b> CPD points, peer networking, international bodies (UIA, CAA, IFLA)"]
    end

    R4 <-->|Co-Regulatory Partnership & Board Nominations| A1
```
...
| :--- | :--- | :--- | :--- | :--- |
| **Architectural Association of Kenya (AAK)** | **1967** (Registered under *Societies Act Cap 108*) | **8 Specialized Chapters:**<br>1. Architects<br>2. Quantity Surveyors<br>3. Town Planners<br>4. Engineers<br>5. Landscape Architects<br>6. Environmental Design<br>7. CPM<br>8. Interior Designers | • Drafts Kenya's primary standard building contract (*AAK Agreement & Conditions of Contract*).<br>• Publishes annual Built Environment Status Reports.<br>• International affiliations: UIA, CAA, AUA. | • **Cap 525 Section 4:** Directly nominated **4 out of 8 members (50%)** of the BORAQS Board.<br>• **Bill No. 47:** Stripped of all statutory nomination seats. |
| **Institute of Quantity Surveyors of Kenya (IQSK)** | **1994** (Registered under *Societies Act Cap 108*) | Dedicated QS Professional Institute | • Publishes the *Building Cost Index* & Construction Cost Handbook.<br>• Standard Methods of Measurement (SMM).<br>• Member of Africa Association of Quantity Surveyors (AAQS). | • Collaborative CPD training and scale-of-fees advisory with BORAQS. |
| **Interior Designers Association of Kenya (IDAK)** | **2013 / 2019** (Registered under *Societies Act Cap 108*) | Commercial, Residential & Hospitality Interior Cadres | • Establishes spatial interior design codes, fire life-safety egress standards, and materials specifications.<br>• Affiliated with IFI (International Federation of Interior Architects/Designers). | • Currently unrepresented on BORAQS under the 1934 Cap 525.<br>• Bill No. 47 offered 1 token seat. |
| **Kenya Society of Environmental Landscape Architects (KSELA)** | **2008** (Registered under *Societies Act Cap 108*) | Ecological, Urban & Landscape Planning Specialists | • Drives environmental landscape guidelines, riparian buffers, urban park standards.<br>• Affiliated with IFLA (International Federation of Landscape Architects). | • Currently unrepresented on BORAQS under Cap 525.<br>• Bill No. 47 offered 1 token seat. |
| **Association of Construction Managers of Kenya (ACMK)** | **2014** (Registered under *Societies Act Cap 108*) | Construction Project Managers & Site Executives | • Professional project management standards aligned with CIOB & CMAA.<br>• Site schedule, cost control, and quality governance. | • Currently unrepresented on BORAQS under Cap 525.<br>• Bill No. 47 offered 1 token seat. |
...
```mermaid
flowchart TD
    C24["<b>Clause 24: Board-Created 'Chapters'</b><br><i>(Conducted under Board Guidelines)</i>"]
    
    C24 --> IMP1["<b>1. Institutional Collision with AAK's 8 Chapters</b><br>• AAK has operated 8 specialized Chapters since 1967.<br>• Creates a state-managed twin structure with identical names.<br>• Confuses state regulation with member advocacy."]
    
    C24 --> IMP2["<b>2. CPD & Revenue Disintermediation</b><br>• Read with Clause 25(3)(b) (Board provides lectures/teaching) & Clause 32(3)(c) (Mandatory CPD for licensing).<br>• Board can monopolize CPDs internally, cutting off association revenue."]
    
    C24 --> IMP3["<b>3. Loss of Co-Regulatory Democracy (Clause 7)</b><br>• Cap 525 Sec 4 gave AAK 50% Board nomination seats.<br>• Bill No. 47 removes all association seats, transferring 100% to CS appointment."]
    
    C24 --> IMP4["<b>4. The Discretionary Recognition Trap (Clause 22(2)(e))</b><br>• Board acts as regulator, chapter operator, and gatekeeper.<br>• Threatens the independence of civil society associations."]
```
...
```mermaid
flowchart TD
    subgraph "7 IN-BILL STATUTORY SAFEGUARDS (AUTOMATED COMPLIANCE)"
        P1["<b>1. Clause 7A: 14-Day Deemed Gazettement</b><br>Prevents ministerial veto by automatically seating elected Council members."]
        P2["<b>2. Clause 6A & 56B: Free National Cloud Gateway + 15% Grants</b><br>Solves County ICT gaps by providing free mobile QR validation & funding hardware via the Safety Levy."]
        P3["<b>3. Clause 5(4) & 38A: Single-Window Recognition</b><br>Bans NCA/EBK/NEMA double-licensing and synchronizes unified site stop-work notices."]
        P4["<b>4. Clause 24A: Statutory Co-Regulation & 80% CPD Rule</b><br>Protects AAK, IQSK, IDAK, KSELA, ACMK by mandating that 80% of CPD training runs through them."]
        P5["<b>5. Clause 56A: Non-Obstante Override of PPADA</b><br>Mandates QCBS (80% Quality / 20% Cost) & disqualifies bids below 70% of scale of fees."]
        P6["<b>6. Clause 53A: The BEAT Fast-Track Tribunal</b><br>Ends 5-10 year High Court delays by requiring 100% cash indemnity bonds for stay applications."]
        P7["<b>7. Clause 23A & 32A: TVET Bridging & Social Housing Credits</b><br>Opens KNQA Level 6-to-7 career ladders and awards CPD credits for slum upgrading pro-bono work."]
    end
```
