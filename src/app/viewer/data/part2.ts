export const part2Data = {
  ...
  sections: [
    ...
    },
    {
            "section": "13",
            "title": "Committees",
            "bill_text": "(1) The Council shall establish a Registration Committee, a Disciplinary Committee, an Education and Training Committee, and discipline-specific Technical Committees for each of the eight regulated professions (Architecture, Engineering, Quantity Surveying, Physical Planning, Construction Project Management, Landscape Architecture, Interior Design, Environmental Design) and TVET Technical Education.\n(2) The Council may co-opt external experts to serve on its committees, provided that the chairperson of every committee must be a member of the Council.",
            "analysis": {
                    "what_it_does": "Empowers KBERC to establish standing committees, explicitly mandating discipline-specific Technical Committees for all 8 regulated professions and TVET Technical Education alongside the Registration, Disciplinary, and Education Committees. External experts may be co-opted, but all committee chairs must be Council members.",
                    "why_it_exists": "A full Council of 9 people cannot operationally manage thousands of registration files, disciplinary proceedings, and specialized accreditation reviews across 8 distinct professions simultaneously. Mandatory Technical Committees ensure every discipline has dedicated peer oversight.",
                    "plain_english": "KBERC creates specialized technical committees for each of the 8 professions (Architecture, Engineering, QS, Planning, CPM, Landscape, Interior Design, Environmental Expert) and TVET cadres. Outside experts can join these committees to advise, but a Council member must always chair.",
                    "policy_objective": "To guarantee 100% technical representation and operational equity for all 8 regulated professions and TVET cadres through dedicated statutory committees.",
                    "who_is_affected": [
